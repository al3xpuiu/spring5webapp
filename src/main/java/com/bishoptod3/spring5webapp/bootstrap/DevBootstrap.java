package com.bishoptod3.spring5webapp.bootstrap;

import com.bishoptod3.spring5webapp.model.Author;
import com.bishoptod3.spring5webapp.model.Book;
import com.bishoptod3.spring5webapp.model.Publisher;
...
import com.bishoptod3.spring5webapp.model.repositories.PublisherRepository;
...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent>{
    ...
    private void initData() {
        ...
        Publisher publisher = new Publisher( "Harper Collins", "121 Main Str" );
        Publisher publisher1 = new Publisher( "Worx", "656 Str" );
